...
class FractionalGaussianNoise(BaseTimeProcess):
    ...
    * Davies, Robert B., and D. S. Harte. "Tests for Hurst effect." Biometrika
    ...
    def _daviesharte(self, n):
        ...
        if self.hurst == 0.5:
            return self.rng.normal(scale=scale, size=n), self._autocovariance(self.hurst, n)
            ...
            return np.fft.irfft(sqrt_eigenvals * w)[:n], self._autocovariance(self.hurst, n)
    ...
    def _hosking(self, n):
        ...
        return fgn, self._autocovariance(self.hurst, n)
...
plt.figure()
plt.plot(_fgn_autocovariance(0.0001, 32)[1:], label='0.0001')
plt.plot(_fgn_autocovariance(0.1, 32)[1:], label='0.1')
plt.plot(_fgn_autocovariance(0.2, 32)[1:], label='0.2')
plt.plot(_fgn_autocovariance(0.3, 32)[1:], label='0.3')
plt.plot(_fgn_autocovariance(0.4, 32)[1:], label='0.4')
plt.plot(_fgn_autocovariance(0.50001, 32)[1:], label='0.5')
plt.plot(_fgn_autocovariance(0.6, 32)[1:], label='0.6')
plt.plot(_fgn_autocovariance(0.7, 32)[1:], label='0.7')
plt.plot(_fgn_autocovariance(0.8, 32)[1:], label='0.8')
plt.plot(_fgn_autocovariance(0.9, 32)[1:], label='0.9')
plt.plot(_fgn_autocovariance(0.9999, 32)[1:], label='0.999')
plt.legend()
plt.show()
